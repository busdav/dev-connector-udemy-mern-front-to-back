...
router.delete("/experience/:exp_id", auth, async (req, res) => {
  try {
    ...
    // Get remove index
    const removeIndex = profile.experience.map(item => item.id).indexOf(req.params.exp_id); // `map` returns new array consisting of the IDs, `indexOf` returns the index of the desired ID
...
router.delete("/education/:edu_id", auth, async (req, res) => {
  try {
    ...
    // Get remove index
    const removeIndex = profile.education.map(item => item.id).indexOf(req.params.edu_id); // `map` returns new array consisting of the IDs, `indexOf` returns the index of the desired ID
